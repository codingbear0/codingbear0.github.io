...
> [!quote] 
> Monolingual fieldwork is the practice of conducting linguistic fieldwork solely through the target language under investigation, without the use of interpreters or a [[/lingua-franca|lingua franca ]]. 

통역사나 [[/lingua-franca|공용어]]<sub>lingua franca</sub>를 사용하지 않고 조사 중인 대상 언어만으로 현장에서 언어를 조사하는 방법을 말한다.
- Kenneth Pike에 의해 토착어를 연구하는 방법으로 개발된 것.
- 우리말로는 ‘단일어 현장 연구’.

<BR />

이 방법의 구체적 모습은 [[/book-ultralearning|Ultralearning]]에서 확인할 수 있다.
